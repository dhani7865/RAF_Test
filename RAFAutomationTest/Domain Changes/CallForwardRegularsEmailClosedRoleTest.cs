...
namespace RAF_SELENIUM_TESTS
{
    ...
    [TestClass]
    public class CallForwardRegularsEmailClosedRoleDomainChangesTest
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\RAF - Call Forward - Regulars Email Closed Role Domain Changes Test 22-11-2022.html";
        ...
        [TestMethod]
        public void test_CallForwardRegularsEmailClosedRoleDomainChangesTestt()
        {

            ExtentStart();
            var test = extent.CreateTest("RAF - Call Forward - Regulars Email Closed Role Domain Changes Test").Info("Test Started");
            ...
            System.Threading.Thread.Sleep(5000);
            // Logging the test in the extent report and pass status
            test.Log(Status.Info, "Selecting a role ID");
