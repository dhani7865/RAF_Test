...
namespace RAF_SELENIUM_TESTS
{
    ...
    [TestClass]
    public class CallForwardReservesEmailClosedRoleDomainChangesTest
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\RAF - Call Forward - Reserves Email Closed Role Domain Changes Test 22-11-2022.html";
        ...
        [TestMethod]
        public void test_CallForwardReservesEmailClosedRoleDomainChangesTest()
        {

            ExtentStart();
            var test = extent.CreateTest("RAF - Call Forward - Reserves Email Closed Role Domain Changes Test").Info("Test Started");
            ...
            selectElement.SelectByText("Reserves ▸ Registered Nurse (Adult) - Reserves [Closed]");
