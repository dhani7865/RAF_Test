...
namespace RAF_SELENIUM_TESTS
{
    ...
    [TestClass]
    public class CallForwardReservesEmailOpenRoleDomainChangesTest
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\RAF - Call Forward - Reserves Email Open Role Domain Changes Test 22-11-2022.html";
        ...
        [TestMethod]
        public void test_CallForwardReservesEmailOpenRoleDomainChangesTest()
        {

            ExtentStart();
            var test = extent.CreateTest("RAF - Call Forward - Reserves Email Open Role Domain Changes Test").Info("Test Started");
            ...
            selectElement.SelectByText("Reserves ▸ Engineering Officer - Reserves [Open]");
