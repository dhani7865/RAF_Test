...
namespace RAF_SELENIUM_TESTS
{
    ...
    [TestClass]
    public class StartScriptRegularsClosedRoleDomainChangesTest
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\RAF - Start Script - Regulars Closed Role Test 22-11-2022.html";
        ...
        [TestMethod]
        public void test_StartScriptRegularsClosedRoleDomainChangesTest()
        {

            ExtentStart();
            var test = extent.CreateTest("RAF - Start Script - Regulars Closed Role Domain Changes Test").Info("Test Started");
            ...
            driver.FindElement(By.Id("FirstName")).SendKeys("Regulars Closed");
            ...
            driver.FindElement(By.Id("LastName")).SendKeys("Role");
            ...
            selectElement = new SelectElement(dropdown);
            selectElement.SelectByText("Job Board");
            ...
            */
            ...
            // Test 35
            // Selecting the role
            driver.FindElement(By.CssSelector("#tableRegularsSearchResultsID tr:nth-child(2) > td:nth-child(1)")).Click();
            driver.FindElement(By.CssSelector("tr:nth-child(2) .selectLink")).Click();

            // 5 seconds implicit wait (C# code)
            System.Threading.Thread.Sleep(2000);
            // Logging the test in the extent report and pass status
            test.Log(Status.Info, "Selecting the role");
