...
namespace RAF_SELENIUM_TESTS
{
    ...
    [TestClass]
    public class StartScriptRegularsOpenRoleDomainChangesTest
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\RAF - Start Script - Regulars Open Role Domain Changes Domain Changes Test 22-11-2022.html";
        ...
        [TestMethod]
        public void test_StartScriptRegularsOpenRoleDomainChangesTest()
        {

            ExtentStart();
            var test = extent.CreateTest("RAF - Start Script - Regulars Open Role Domain Changes Test").Info("Test Started");
            ...
            driver.FindElement(By.Id("DateOfBirth")).SendKeys("01/02/1992");
            ...
            */
            ...
            driver.FindElement(By.Id("Addresses_0__Postcode")).Clear();
            driver.FindElement(By.Id("Addresses_0__Postcode")).SendKeys("BS1 3LG");
