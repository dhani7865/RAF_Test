...
namespace RAF_SELENIUM_TESTS
{
    ...
    [TestClass]
    public class StartScriptReservesOpenRoleDomainChangesTest
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\RAF - Start Script - Reserves Open Role Domain Changes Test 22-11-2022.html";
        ...
        [TestMethod]
        public void test_StartScriptReservesOpenRoleDomainChangesTest()
        {

            ExtentStart();
            var test = extent.CreateTest("RAF - Start Script - Reserves Open Role Domain Changes Test").Info("Test Started");
            ...
            driver.FindElement(By.Id("ContactMethods_1__Value")).SendKeys("078888888");
            ...
            */
            ...
            driver.FindElement(By.Id("SelectedReservesRoleId"));

            dropdown = driver.FindElement(By.Id("SelectedReservesRoleId"));

            selectElement = new SelectElement(dropdown);
            selectElement.SelectByText("Cyber Roles (Open)");
