...
namespace RAF_SELENIUM_TESTS
{
    ...
    [TestClass]
    public class ContactEventsBookingTest
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\RAF Contact Button - Events Booking Test 21-11-2022.html";
        ...
        [TestMethod]
        public void test_ContactEventsTest()
        {

            ExtentStart();
            var test = extent.CreateTest("RAF - Contact Button - Events Booking Test").Info("Test Started");
            ...
            // Logging the test in the extent report and pass status
            test.Log(Status.Info, "Clicking on the Contact Button");
            ...
            driver.FindElement(By.Id("ContactSearchViewModel_FirstName")).SendKeys("fourth");
            ...
            driver.FindElement(By.Id("ContactSearchViewModel_LastName")).SendKeys("test");
