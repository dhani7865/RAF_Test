...
namespace RAF_SELENIUM_TESTS
{
    ...
    [TestClass]
    public class StartScriptEventOptionTest
    {
        ...
        [TestMethod]
        public void test_StartScriptEventOptionTest()
        {
            ...
            driver.FindElement(By.Id("ContactMethods_1__Value")).SendKeys("07666666666");
            ...
            // Test 43
            // Selecting the From Session Start Date
            driver.FindElement(By.Id("FromSessionStartDate")).Click();
            driver.FindElement(By.LinkText("26")).Click();

            // 5 seconds implicit wait (C# code)
            System.Threading.Thread.Sleep(2000);
            // Logging the test in the extent report and pass status
            test.Log(Status.Info, "Selecting the From Session Start Date");
            ...
            // Test 47
            // Clicking YES on the dialogue screen
            driver.FindElement(By.Id("YesNoDialogueYes")).Click();

            // 5 seconds implicit wait (C# code)
            System.Threading.Thread.Sleep(2000);
            // Logging the test in the extent report and pass status
            test.Log(Status.Info, "Clicking YES on the dialogue screen");
            ...
            selectElement = new SelectElement(dropdown);
            selectElement.SelectByText("Leeds");
            ...
            System.Threading.Thread.Sleep(2000);
            // Logging the test in the extent report and pass status
            test.Log(Status.Info, "Clicking the Details");
