...
namespace RAF_SELENIUM_TESTS
{
    ...
    [TestClass]
    public class CallForwardRegularsEmailTest
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\RAF - Call Forward - Regulars Email matches updated template Test 22-11-2022.html";
        ...
        [TestMethod]
        public void test_CallForwardRegularsEmailTest()
        {
