...
namespace RAF_SELENIUM_TESTS
{
    ...
    [TestClass]
    public class ReservesRegistrationClosedRoleFollowUpEmailTest
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\RAF - Role Admin Button - Reserves Registration Closed Role Follow Up Email matches updated template Test 22-11-2022.html";
        ...
        [TestMethod]
        public void test_ReservesRegistrationClosedRoleFollowUpEmailTest()
        {

            ExtentStart();
            var test = extent.CreateTest("RAF - Role Admin Button - Reserves Registration Closed Role Follow Up Email matches updated template Test").Info("Test Started");
