...
namespace RAF_SELENIUM_TESTS
{
    ...
    [TestClass]
    public class ReservesRegistrationSpecialistClosedRoleEmailTest
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\RAF - Role Admin Button - Reserves Registration Specialist Closed Role Email matches updated template Test 22-11-2022.html";
        ...
        [TestMethod]
        public void test_ReservesRegistrationSpecialistClosedRoleEmailTest()
        {

            ExtentStart();
            var test = extent.CreateTest("RAF - Role Admin Button - Reserves Registration Specialist Closed Role Email matches updated template Test").Info("Test Started");
            ...
            driver.FindElement(By.Id("value")).SendKeys("radiographer");
