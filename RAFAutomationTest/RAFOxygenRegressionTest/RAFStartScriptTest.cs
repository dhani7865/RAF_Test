...
namespace RAF_SELENIUM_TESTS
{
    ...
    [TestClass]
    public class StartScriptClosedRoleTest
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\RAF Start Script Button Test 21-11-2022.html";
        ...
        [TestMethod]
        public void test_StartScriptTest()
        {
