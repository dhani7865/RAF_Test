...
namespace RAF_SELENIUM_TESTS
{
    ...
    [TestClass]
    public class RAF_StartScriptOpenRoleTestTwo
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\RAF Start Script Open Role Test Two Button 21-11-2022.html";
        ...
        [TestMethod]
        public void test_StartScriptOpenRoleTestTwo()
        {

            ExtentStart();
            var test = extent.CreateTest("RAF - Start Script Open Role Two Test").Info("Test Started");
            ...
            driver.FindElement(By.Id("FirstName")).SendKeys("Open");
            ...
            driver.FindElement(By.Id("LastName")).SendKeys("Second Role");
