...
namespace RAF_SELENIUM_TESTS
{
    ...
    [TestClass]
    public class StartScriptRegularsOpenRoleTest
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\RAF Start Script Regulars Open Role Test Button 21-11-2022.html";
        ...
        [TestMethod]
        public void test_StartScriptOpenRoleTest()
        {

            ExtentStart();
            var test = extent.CreateTest("RAF - Start Script - Regulars Open Role Email Education Test").Info("Test Started");
            ...
            driver.FindElement(By.Id("FirstName")).SendKeys("Regulars");
            ...
            driver.FindElement(By.Id("LastName")).SendKeys("Open Role");
            ...
            dropdown.FindElement(By.XPath("//option[. = 'All Groups']")).Click();
            ...
            // Test 31
            // Selecting a open role
            wait.Until(ExpectedConditions.ElementExists(By.CssSelector("tr:nth-child(4) .selectLink"))).Click();

            // driver.FindElement(By.CssSelector("tr:nth-child(4) .selectLink")).Click();

            // 5 seconds implicit wait (C# code)
            System.Threading.Thread.Sleep(5000);
            // Logging the test in the extent report and pass status
            test.Log(Status.Info, "Selecting a open role");
