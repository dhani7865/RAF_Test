...
{
    [TestCategory("Role Admin Search Amendment")]
    [TestClass]
    public class RoleAdminSearchTest
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\RAF Role Admin Button - Search Amendment Test 18-11-2022.html";
        ...
        [TestMethod]
        public void test_RoleAdminSearchTest()
        {

            ExtentStart();
            var test = extent.CreateTest("RAF - Role Admin Button - Search Amendment Test").Info("Test Started");
